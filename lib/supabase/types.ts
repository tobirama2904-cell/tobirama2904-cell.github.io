...
export interface Message { id: string; convo_id: string; sender_id: string; kind: 'text' | 'image' | 'video' | 'file' | 'voice' | 'system' | 'ai' | 'poll'; text: string; media_url: string | null; reply_to: string | null; disappear_at: string | null; instant?: boolean; pinned?: boolean; created_at: string; sender?: Profile; reactions?: Record<string, string[]>; }
