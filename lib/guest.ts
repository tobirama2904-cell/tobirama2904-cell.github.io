...
function blank(): GuestDB {
  ...
  return {
    ...
    msgs: { gc1: [{ id: 'gm1', convo_id: 'gc1', sender_id: 'legion', kind: 'ai', text: 'Привет! Подключи Supabase — и сможешь переписываться с настоящими людьми.', media_url: null, reply_to: null, disappear_at: null, created_at: new Date().toISOString() }] },
  };
}
